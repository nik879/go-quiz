...
func CreateRouter() *mux.Router {
	...
	questionRouter.HandleFunc("/{id}/answer/{answer_id}", controllers.AnswerQuestion).Methods("GET") //done
	questionRouter.HandleFunc("/{id}", controllers.GetSingleQuestion).Methods("GET")
